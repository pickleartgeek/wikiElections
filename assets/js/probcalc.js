 ...
 */
function PC_computeAlphas(polls, candidateIds, electionDate, opts = {}) {
  const agg = BaseCalc_aggregate(polls, candidateIds, electionDate, opts);
  const alphas = {};
 ...
 */
function ProbCalc_run(polls, candidateIds, electionDate, simulations = 20000, opts = {}) {
  const { alphas, averages, totalAlpha } = PC_computeAlphas(polls, candidateIds, electionDate, opts);
